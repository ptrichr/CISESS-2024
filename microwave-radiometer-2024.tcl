...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/vivado_project/microwave-radiometer-2024.srcs/utils_1/imports/synth_1/radiometer_toplevel.dcp"]"\
  ...
  set files [list \
 "[file normalize "$origin_dir/src/radiometer.v"]"\
 "[file normalize "$origin_dir/src/adc_clock_divider.v"]"\
 "[file normalize "$origin_dir/src/uart_tx.v"]"\
 "[file normalize "$origin_dir/src/switch_controller.v"]"\
 "[file normalize "$origin_dir/src/adc.v"]"\
...
set_property -name "top" -value "radiometer" -objects $obj
...
set file "synth_1/radiometer_toplevel.dcp"
